...
"""
Prueba tu agente Gabi sin necesitar WhatsApp.
...
# Agregar el directorio raíz al path para que Python encuentre el módulo agent/
...
async def main():
    ...
    print()
    print("=" * 55)
    print("   AgentKit — Test Local | LAGABIANI")
    print("=" * 55)
    print()
